...
[![version](https://img.shields.io/badge/release-0.4.0-success)](https://deno.land/x/http_error@0.4.0)
[![deno doc](https://doc.deno.land/badge.svg)](https://doc.deno.land/https/deno.land/x/http_error@0.4.0/mod.ts)
...
import { HttpError, isHttpError } from "https://deno.land/x/http_error@0.4.0/mod.ts";
// Import from GitHub
import { HttpError, isHttpError } "https://raw.githubusercontent.com/udibo/http_error/0.4.0/mod.ts";
```
...
```js
import { HttpError, isHttpError } from "./http_error_0.4.0.js";
```
...
```js
import { HttpError, isHttpError } from "./http_error_0.4.0.mjs";
```
